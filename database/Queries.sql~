...
insert into libro (titulo, autor, disponible) values ("Cien años de Soledad", "Gabriel Garcia Marquez", true);
insert into libro (titulo, autor, disponible) values ("Viaje al centro de la tierra", "Julio Verne", true);
...
insert into prestamo (id_texto, id_persona) values (3,1);
